...
- template: content-feature
  ...
  content: <strong><span class="TextRun SCXW36978653 BCX0">Corpus Fund:<br>    </span></strong><span
    ...
    Rent for a building. And thus, the corpus helps to keep an organisation financially
    ...
    be transferred to the corpus fund. Rest 85% has to be used to fund program activities.Donations-
