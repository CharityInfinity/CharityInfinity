...
- template: content-feature
  ...
  content: '<strong><span class="TextRun SCXW36978653 BCX0">Ways of getting corpus
    ...
    SCXW36978653 BCX0"> : </span><a href="https://www.youtube.com/watch?v=iLutkCwxyIs"
                                    title="https://www.youtube.com/watch?v=iLutkCwxyIs" onMouseOver="this.style.cursor='pointer'"><button style="background-color:lightblue; padding:5px;">Watch now</button></a>'
  media:
